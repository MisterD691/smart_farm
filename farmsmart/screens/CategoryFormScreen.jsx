  ...
  return (
      <SafeAreaView className="flex-1 bg-[#D5D8DF] px-4 space-y-4 relative">
        <View className="flex-row justify-between items-center mb-4">
              <View>
                  <Text className="text-2xl font-bold mt-4">Enregistrer une</Text>
                  <Text className="text-2xl font-bold mb-4">Catégorie de produit</Text>
              </View>
          ...
          <Text className="mt-4 mb-3">Veuillez renseigner les informations de la catégorie</Text>
              <TextInput style={styles.input} placeholder='Libellé' value={name} onChangeText={setName} autoCorrect={false}
          autoCapitalize='none' />
